/**
 * Bug #9418: Cannot use responseFormat with middleware (todoListMiddleware)
 * 
 * This example demonstrates the bug where using responseFormat (structured output)
 * with middleware causes issues. This is the same as scenario 02 but with
 * todoListMiddleware added.
 * 
 * Expected Error:
 * Error: Invalid response from "wrapModelCall" in middleware "...": 
 * expected AIMessage, got object
 * 
...
async function main() {
  console.log("Bug #9418: responseFormat with middleware (todoListMiddleware)");
  console.log("===============================================================\n");
  ...
  try {
    ...
    // Create agent with responseFormat AND todoListMiddleware - this will fail
    ...
    console.log("Invoking agent with structured output and middleware...\n");

    // This call will fail due to responseFormat + middleware conflict
